...
While editing a sketch, **Export SVG** downloads the sketch view as a standalone file with its lines, regions, constraints, and reference faces. In the model view, **Export PNG** downloads the current 3D rendering at screen size.
