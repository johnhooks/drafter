...
There are no curves, angled planes, fillets, or assemblies. There is no undo yet. The 3D view has a fixed isometric angle. If you need any of those, this is the wrong tool.
