...
export function useKeyHandler() {
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      if (e.defaultPrevented || (e.target instanceof HTMLElement && e.target.closest('[data-layout-control]')) || isText(e.target) || (e.target instanceof HTMLElement && e.target.closest('[role="dialog"], [role="alertdialog"]'))) return
