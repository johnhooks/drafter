...
const doc: Document = {
  ...newDocument('t'),
  features: [
    { kind: 'sketch', id: 's1', name: 'Sketch 1', plane: DEFAULT_PLANE, rects: [{ id: 'r1', u1: IN(0), v1: IN(0), u2: IN(24), v2: IN(24) }] },
    { kind: 'extrude', id: 'e1', name: 'Extrude 1', sketchId: 's1', rectIds: ['r1'], distance: IN(24), op: 'new' },
    { kind: 'sketch', id: 's2', name: 'Sketch 2', plane: { kind: 'face', featureId: 'e1', face: 'uMax' }, rects: [{ id: 'r2', u1: IN(-20), v1: IN(4), u2: IN(-4), v2: IN(8) }] },
